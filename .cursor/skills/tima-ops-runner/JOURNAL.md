# TIMA operations error journal

Raw accumulation log for the `tima-ops-runner` skill. This file is maintained
...
- New error type: create a new entry with the next sequential code `OPS-NNN`,
...
```markdown
## OPS-001: <short error type name>
- type: <category: docker | wsl | adb | gradle | launcher | ...>
- count: 1
- first_seen: YYYY-MM-DD
- last_seen: YYYY-MM-DD
- status: OPEN | RESOLVED | PROMOTED
- symptom: <observed symptom, no secrets>
- context: <command/stage where it occurred>
