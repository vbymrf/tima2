...
sealed interface PageStep {
    ...
    data class Page(
        ...
        /**
         * **Дружит ли хозяин страницы со мной** — то есть добавил ли он меня к себе.
         *
         * Сервер отдаёт это только у чужой страницы; у своей поля нет, и `null` здесь
         * значит «не сказано», а не «не дружит». Дружба односторонняя (ПЛАН-КОНТАКТОВ
         * Д1б): это ответ про ЕГО список, а не про мой, и путать их нельзя.
         */
