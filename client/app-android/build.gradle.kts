...
android {
    ...
    defaultConfig {
        ...
        // Суффикс рабочей сборки (правило заказчика 2026-09-19): проверочная сборка в
        // середине работы называется иначе, чем готовая, и по имени на экране «О
        // программе» и в журнале видно, что это не та сборка, что числится в КЛИЕНТЫ.md.
        // Номер при этом не растёт: растить его на каждую пробу — значит сделать номер
        // бессмысленным. Ставится так: `-Ptima.versionSuffix=-wip`.
        versionName = (property("tima.versionName") as String) +
            (findProperty("tima.versionSuffix") as String? ?: "")
