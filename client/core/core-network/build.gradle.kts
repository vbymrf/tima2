...
kotlin {
    ...
    sourceSets {
        commonMain.dependencies {
            // Журнал: сетевой слой пишет в него вызовы и отказы — по ним потом читается
            // отчёт о проблеме (ПЛАН-ОТЛАДКИ.md, Б1). Пишется путь, код и время; тела
            // запроса и ответа не пишутся никогда — в них переписка.
            ...
            // Порт медиа-хранилища объявлен в core-media; здесь его реализация по HTTP.
            api(projects.core.coreMedia)
