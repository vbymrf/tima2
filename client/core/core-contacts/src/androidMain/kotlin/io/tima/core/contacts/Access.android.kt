...
object AndroidContactsAccess {
     ...
     * не через кого. Поймано на realme 2026-09-05: диалог не появлялся вовсе, а флаги
    ...
    fun answered(requestCode: Int, results: IntArray) {
        ...
        if (granted) Journal.note(LogCode.PERM_GRANTED, "контакты", "что" to "READ_CONTACTS")
        else Journal.trouble(LogCode.PERM_DENIED, "контакты", "что" to "READ_CONTACTS")
