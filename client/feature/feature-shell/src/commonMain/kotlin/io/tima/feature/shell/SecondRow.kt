 ...
 *
 * **Три ряда — три вида, и путать их нечем.** Вкладка залита салатовым, невыбранная
 * несёт тихий оттенок навигации; подвкладка залита тем же салатовым, а невыбранная —
 * нейтральным серым; переключатель режима живёт в общей серой капсуле ([ModeSwitch]).
 * Промежуточная редакция того же дня набрала все три одинаковыми чипами, и «Открытое»
 * с «Личным» встали пятой и шестой подвкладкой — заказчик прочёл это ровно так.
 *
 ...
 *
 * **Серая капсула, внутри сегменты, выбранный залит салатовым.** Образец назван
 * заказчиком: `телефон/окна/медиа.html`, где этим переключают «Лента / Слайды». В
 ...
 * .режим      { padding: 5px 12px; font-size: var(--щ6); font-weight: 700; color: var(--чёрный-50) }
