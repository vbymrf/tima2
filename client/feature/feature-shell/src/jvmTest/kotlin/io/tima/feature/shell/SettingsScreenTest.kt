...
class SettingsScreenTest {
     ...
     * одиннадцать. Сверх макета четыре, и все четыре — решения заказчика, названные в
     * перечне: «Обновление» (2026-08-26, рядом с «О приложении»), «Виртуальные аккаунты»
     * (2026-09-05, ПЛАН-КОНТАКТОВ.md Д10…Д12), «Шрифты и размеры» (2026-09-16,
     * ПЛАН-ШРИФТОВ Ш4: «Оформление» разрослось и поделено на «Цвета» и шрифты) и
     * «Испытательный режим звонков» (2026-09-19, ПЛАН-СТЕНДА-ЗВОНКОВ §4).
     * Пункт, добавленный мимо решения, уронит
     * тест — и правильно, потому что решает здесь макет.
     *
     * **Последний — временный, и это единственный такой в списке.** Он уйдёт вместе со
     * стендом, и тогда число вернётся к четырнадцати. Уменьшение здесь так же законно,
     * как и увеличение, — но только вместе с концом испытаний, а не «заодно».
     */
    @Test
    fun разделов_пятнадцать_в_четырёх_группах() {
        assertEquals(
            15,
            SettingsItem.entries.size,
            "список разошёлся с макетом: одиннадцать пунктов оттуда плюс «Обновление», " +
                "«Виртуальные аккаунты», «Шрифты и размеры» и временный «Испытательный режим звонков»",
        )
