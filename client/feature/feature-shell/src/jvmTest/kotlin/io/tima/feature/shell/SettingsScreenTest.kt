...
class SettingsScreenTest {
     ...
     * одиннадцать. Сверх макета три, и все три — решения заказчика, названные в перечне:
     * «Обновление» (2026-08-26, рядом с «О приложении») и «Виртуальные аккаунты»
     * (2026-09-05, ПЛАН-КОНТАКТОВ.md Д10…Д12) и «Шрифты и размеры» (2026-09-16,
     * ПЛАН-ШРИФТОВ Ш4: «Оформление» разрослось и поделено на «Цвета» и шрифты).
     * Пункт, добавленный мимо решения, уронит
     * тест — и правильно, потому что решает здесь макет.
     */
    @Test
    fun разделов_четырнадцать_в_четырёх_группах() {
        assertEquals(
            14,
            SettingsItem.entries.size,
            "список разошёлся с макетом: одиннадцать пунктов оттуда плюс «Обновление» " +
                "«Виртуальные аккаунты» и «Шрифты и размеры»",
        )
