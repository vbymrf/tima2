...
class SettingsScreenTest {
     ...
     * одиннадцать. Сверх макета два, и оба — решения заказчика, названные в самом перечне:
     * «Обновление» (2026-08-26, рядом с «О приложении») и «Виртуальные аккаунты»
     * (2026-09-05, ПЛАН-КОНТАКТОВ.md Д10…Д12). Пункт, добавленный мимо решения, уронит
     * тест — и правильно, потому что решает здесь макет.
     */
    @Test
    fun разделов_тринадцать_в_четырёх_группах() {
        assertEquals(
            13,
            SettingsItem.entries.size,
            "список разошёлся с макетом: одиннадцать пунктов оттуда плюс «Обновление» " +
                "и «Виртуальные аккаунты»",
        )
