...
| [макет-ui-семафор_2/](./макет-ui-семафор_2/README.md) | **Вторая редакция «Семафора»:** квадратные аватары, салатовый как навигация и действие, аватар внутри сообщения, новостная лента без рамок |
| [макет-ui-семафор-тьма_2/](./макет-ui-семафор-тьма_2/README.md) | Тёмная тема второй редакции — фоны сообщений полутонами темнее |
