...
| [макет-ui-предложение/](./макет-ui-предложение/README.md) | Макет UI: предложение по стилю для семи окон из ТЗ — вариант «Бумага» |
| [макет-ui-холод/](./макет-ui-холод/README.md) | То же содержимое, второй визуальный язык — вариант «Холод» (космос, стекло, неон) |
| [макет-ui-тепло/](./макет-ui-тепло/README.md) | То же содержимое, третий визуальный язык — вариант «Тепло» (монохром, круги, тени) |
| [макет-ui-оттиск/](./макет-ui-оттиск/README.md) | Вариант «Оттиск»: меняется не палитра, а состав — без иконок, без аватаров-картинок, без пузырей |
| [макет-ui-семафор/](./макет-ui-семафор/README.md) | Вариант «Семафор» на заданной палитре: шесть цветов, за каждым закреплён один смысл |
| [макет-ui-семафор-тьма/](./макет-ui-семафор-тьма/README.md) | Тёмная тема «Семафора» — не концепт, а второй набор значений: `стиль.css` + `тьма.css` |
| [макет-ui-семафор_2/](./макет-ui-семафор_2/README.md) | **Вторая редакция «Семафора»:** квадратные аватары, салатовый как навигация и действие, аватар внутри сообщения, лента без рамок, каталог по **разделам** |
| [макет-ui-семафор-тьма_2/](./макет-ui-семафор-тьма_2/README.md) | Тёмная тема второй редакции — фоны сообщений полутонами темнее; разделы приехали одним правилом |
