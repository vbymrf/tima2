...
| Обновление клиента без магазина: поток сборок, три уровня настойчивости, чем проверяется пакет | [0022](./adr/0022-self-distributed-updates.md) |
| Сроки журнала, файлы по дням и глубина отчёта: месяц или объём, «когда началось» | [0023](./adr/0023-diary-retention-and-report-depth.md) |
