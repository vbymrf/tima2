...
| [интерфейс2.md](./интерфейс2.md) | **Функционал по макету:** что приложение обязано уметь, вычитано из Layout-UI-light; со временем заменяет doc_UI |
| [doc_UI/](./doc_UI/00-index.md) | UI-ТЗ: 35 спецификаций экранов (WireMD) — замысел. **Заменяется** [интерфейс2.md](./интерфейс2.md); соответствие файлов — его §13, непокрытое макетом — §12 |
| [Layout-UI-light/](./Layout-UI-light/README.md) | **Макет UI, светлая тема:** окна и подокна в HTML — квадратные аватары, салатовый как навигация и действие, аватар внутри сообщения, лента без рамок, каталог по **разделам**. Там же [палитра](./Layout-UI-light/палитра.html) |
