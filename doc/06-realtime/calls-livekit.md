...
> **Приостановлено на время испытаний** — [ADR-0006 Поправка-2](../adr/0006-livekit-media-policy.md) (2026-09-19). Абзац выше опирался на утверждение, а не на измерение; чтобы его проверить, свои пресеты, пороги и таймеры на время испытаний разрешены — **за флагом** испытательного режима. Что и как меряется — [doc_mig/ПЛАН-СТЕНДА-ЗВОНКОВ.md](../../doc_mig/ПЛАН-СТЕНДА-ЗВОНКОВ.md). Вернётся Поправкой-3 с числами.
