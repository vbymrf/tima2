...
> **Заменяется:** функционал по макету собран в
> [интерфейс2.md](../интерфейс2.md); соответствие файлов — его §13, а темы без
> нарисованного интерфейса — §12. Эти файлы не правятся и будут удалены, когда
> новый документ отлежится.
>
