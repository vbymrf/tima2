...
const (
	...
	//
	// 160 → 164 (Д1б, друзья): добавить, убрать, список, «он мне друг?». Последний
	// нужен ленте: она спрашивает про одного читателя, а не читает список целиком.
	storeMethodBudget = 164
